...
sys.path.insert(0, os.path.abspath("../src/bi_toolbox"))
...
html_theme_options = {
    ...
    "icon_links": [
        {
            ...
            "url": "https://github.com/amr-sheriff/BI-Toolbox",  # required
    ...
    "external_links": [
        {"name": "Legacy reference", "url": "#"},
    ],
}

html_context = {
    "display_github": True,  # Integrate GitHub
    "github_user": "amr-sheriff",  # Username
    "github_repo": "BI-Toolbox",  # Repo name
